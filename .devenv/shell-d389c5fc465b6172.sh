...
mesonFlags=''
export mesonFlags
DEVENV_RUNTIME='/tmp/devenv-909207b'
...
export name
outputInfo='out'
DEVENV_DOTFILE='/home/robbiec/Git/pfun-cma-model/.devenv'
...
DEVENV_ROOT='/home/robbiec/Git/pfun-cma-model'
export DEVENV_ROOT
...
PKG_CONFIG_PATH='/nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/lib/pkgconfig'
export PKG_CONFIG_PATH
NIX_NO_SELF_RPATH='1'
DEVENV_STATE='/home/robbiec/Git/pfun-cma-model/.devenv/state'
export DEVENV_STATE
declare -a envBuildTargetHooks=()
system='x86_64-linux'
export system
NIX_LDFLAGS='-rpath /nix/store/56xnwhadwlr693c8dlm5v3j9q746ncd0-devenv-shell-env/lib '
export NIX_LDFLAGS
patches=''
export patches
...
export stdenv
out='/nix/store/56xnwhadwlr693c8dlm5v3j9q746ncd0-devenv-shell-env'
export out
DEVENV_TASK_FILE='/nix/store/1cvbxwh1cq8qrk6zqb4lk3kxdbbr0ppd-tasks.json'
export DEVENV_TASK_FILE
preferLocalBuild='1'
export preferLocalBuild
prefix='/nix/store/56xnwhadwlr693c8dlm5v3j9q746ncd0-devenv-shell-env'
NM='nm'
export NM
shell='/nix/store/2hjsch59amjs3nbgh7ahcfzm2bfwl8zi-bash-5.3p9/bin/bash'
export shell
...
DEVENV_PROFILE='/nix/store/zsff36xyw5ljf9l09v69sfm0kbxzcava-devenv-profile'
export DEVENV_PROFILE
declare -a envBuildBuildHooks=()
declare -a pkgsBuildHost=('/nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev' '/nix/store/0550j0i8bmzxbcnzrg1g51zigj7y12ih-bash-interactive-5.3p9' '/nix/store/7wvr8k4s223w4kk7q3dn2knkspjk0pdz-hello' '/nix/store/8x49w8i0vafv34rlc6h4a0f7z0z2qpb5-git-2.53.0' '/nix/store/1nv3i8mpypy3d516f4pd95m0w72r73jy-pkg-config-wrapper-0.29.2' '/nix/store/590yx3aynyhs48jyk8ip37fk1mjqfhkb-patchelf-0.15.2' '/nix/store/gz3rknshr1ywis4mjaqrgj3z2shp3n3v-update-autotools-gnu-config-scripts-hook' '/nix/store/0y5xmdb7qfvimjwbq7ibg1xdgkgjwqng-no-broken-symlinks.sh' '/nix/store/cv1d7p48379km6a85h4zp6kr86brh32q-audit-tmpdir.sh' '/nix/store/85clx3b0xkdf58jn161iy80y5223ilbi-compress-man-pages.sh' '/nix/store/p3l1a5y7nllfyrjn2krlwgcc3z0cd3fq-make-symlinks-relative.sh' '/nix/store/5yzw0vhkyszf2d179m0qfkgxmp5wjjx4-move-docs.sh' '/nix/store/fyaryjvghbkpfnsyw97hb3lyb37s1pd6-move-lib64.sh' '/nix/store/kd4xwxjpjxi71jkm6ka0np72if9rm3y0-move-sbin.sh' '/nix/store/pag6l61paj1dc9sv15l7bm5c17xn5kyk-move-systemd-user-units.sh' '/nix/store/cmzya9irvxzlkh7lfy6i82gbp0saxqj3-multiple-outputs.sh' '/nix/store/x8c40nfigps493a07sdr2pm5s9j1cdc0-patch-shebangs.sh' '/nix/store/cickvswrvann041nqxb0rxilc46svw1n-prune-libtool-files.sh' '/nix/store/xyff06pkhki3qy1ls77w10s0v79c9il0-reproducible-builds.sh' '/nix/store/z7k98578dfzi6l3hsvbivzm7hfqlk0zc-set-source-date-epoch-to-latest.sh' '/nix/store/pilsssjjdxvdphlg2h19p0bfx5q0jzkn-strip.sh' '/nix/store/kbw2j1vag664b3sj3rjwz9v53cqx87sb-gcc-wrapper-15.2.0' '/nix/store/4yi6jj75bb5hhdzpzlxfyf69d35wsf2x-binutils-wrapper-2.44' )
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/hlxw2q9qansq7bn52xvlb5badw3z1v8s-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/zsff36xyw5ljf9l09v69sfm0kbxzcava-devenv-profile" ]
then
  ln -snf /nix/store/zsff36xyw5ljf9l09v69sfm0kbxzcava-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
mkdir -p /tmp/devenv-909207b
ln -snf /tmp/devenv-909207b /home/robbiec/Git/pfun-cma-model/.devenv/run
...
{
  if [[ ":${DIRENV_ACTIVE-}:" == *":/home/robbiec/Git/pfun-cma-model:"* ]]; then
...
'
export shellHook
NIX_CFLAGS_COMPILE=' -frandom-seed=56xnwhadwl -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include'
...
XDG_DATA_DIRS='/nix/store/0550j0i8bmzxbcnzrg1g51zigj7y12ih-bash-interactive-5.3p9/share:/nix/store/8x49w8i0vafv34rlc6h4a0f7z0z2qpb5-git-2.53.0/share:/nix/store/1nv3i8mpypy3d516f4pd95m0w72r73jy-pkg-config-wrapper-0.29.2/share:/nix/store/590yx3aynyhs48jyk8ip37fk1mjqfhkb-patchelf-0.15.2/share'
...
LD='ld'
export LD
nativeBuildInputs='/nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev /nix/store/7wvr8k4s223w4kk7q3dn2knkspjk0pdz-hello /nix/store/8x49w8i0vafv34rlc6h4a0f7z0z2qpb5-git-2.53.0 /nix/store/1nv3i8mpypy3d516f4pd95m0w72r73jy-pkg-config-wrapper-0.29.2'
...
exec /tmp/devenv-envuMRD8F/script 