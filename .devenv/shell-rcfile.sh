...
source "/home/robbiec/Git/pfun-cma-model/.devenv/shell-env.sh"
...
__devenv_reload_apply() {
    ...
    if [ -f "/tmp/devenv-reload-129152.sh" ]; then
        ...
        source "/tmp/devenv-reload-129152.sh"
        rm -f "/tmp/devenv-reload-129152.sh"
