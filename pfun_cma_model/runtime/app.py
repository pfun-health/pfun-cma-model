...
from pfun_cma_model.pathdefs import PRIVATE_ROUTES
from pfun_cma_model.runtime.src.errors import BadRequestError
...
def fit_model_to_data():
    ...
    try:
        ...
        error_response = Response(
            content={"error": "failed to fit data. See error message on server log."},
            status_code=500,
            headers={"Content-Type": "application/json"},
        )
