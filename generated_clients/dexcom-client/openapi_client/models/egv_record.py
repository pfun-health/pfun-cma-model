...
class EGVRecord(BaseModel):
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['unknown', 'high', 'low', 'ok']):
    ...
    def trend_validate_enum(cls, value):
        ...
        if value not in set(['none', 'unknown', 'doubleUp', 'singleUp', 'fortyFiveUp', 'flat', 'fortyFiveDown', 'singleDown', 'doubleDown', 'notComputable', 'rateOutOfRange']):
    ...
    def rate_unit_validate_enum(cls, value):
        ...
        if value not in set(['unknown', 'mg/dL/min', 'mmol/L/min']):
