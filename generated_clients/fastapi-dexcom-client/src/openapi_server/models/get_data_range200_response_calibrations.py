...
from openapi_server.models.data_range_moment import DataRangeMoment
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class GetDataRange200ResponseCalibrations(BaseModel):
    """
    GetDataRange200ResponseCalibrations
    """ # noqa: E501
    start: Optional[DataRangeMoment] = None
    end: Optional[DataRangeMoment] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "start": DataRangeMoment.from_dict(obj.get("start")) if obj.get("start") is not None else None,
            "end": DataRangeMoment.from_dict(obj.get("end")) if obj.get("end") is not None else None
        })
        return _obj
