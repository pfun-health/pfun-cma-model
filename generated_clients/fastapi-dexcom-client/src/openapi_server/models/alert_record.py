...
class AlertRecord(BaseModel):
    ...
    def alert_name_validate_enum(cls, value):
        ...
        if value not in ('unknown', 'high', 'low', 'rise', 'fall', 'outOfRange', 'urgentLow', 'urgentLowSoon', 'noReadings', 'fixedLow',):
    ...
    def alert_state_validate_enum(cls, value):
        ...
        if value not in ('unknown', 'inactive', 'activeSnoozed', 'activeAlarming',):
